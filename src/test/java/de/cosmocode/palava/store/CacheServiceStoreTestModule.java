...
/**
 * Test {@link Module} for {@link CacheServiceStoreTest}.
 *
 * @since 1.0
 * @author Willi Schoenborn
 */
public final class CacheServiceStoreTestModule implements Module {
    ...
    public void configure(Binder binder) {
        ...
        binder.install(new EhCacheServiceModule());
    }
